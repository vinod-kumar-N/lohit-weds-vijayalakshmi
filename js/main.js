...
setupCountdown(".campaign-0", Date.now(), 1719297000000);
 ...
 *  Add to Calendar
  ======================================================= */
const event = {
    title: "Lohit Nayaka & Vijayalakshmi Wedding",
    startDate: "20240625T173000",
    endDate: "20240626T120000",
    location: "75MF+4R6, SKP Temple, SKPT Road, Y N Hosakote, Karnataka 572141",
    description: "Important - Lohit Nayaka & Vijayalakshmi Wedding",
};
...
function openGoogleMaps() {
    const latitude = 14.282809665480768;  // Example latitude
    const longitude = 77.17451057993244;  // Example longitude
...
function openWhatsApp(phoneNumber) {
    const message = "https://main--lohit-weds-vijayalakshmi.netlify.app/\n\nHello, I need information regarding Lohit's wedding";
